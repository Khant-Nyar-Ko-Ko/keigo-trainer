export default function PageHeader({
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-lg gap-3 mb-10 text-center">
      <span className="text-xs font-semibold tracking-wide uppercase text-accent">{mode}</span>
      <h1 className="text-3xl font-bold font-heading text-ink sm:text-4xl">{title}</h1>
